...
class Advert extends \ESIEA\PlatformBundle\Entity\Advert implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ESIEA\\PlatformBundle\\Entity\\Advert' . "\0" . 'id', '' . "\0" . 'ESIEA\\PlatformBundle\\Entity\\Advert' . "\0" . 'date', '' . "\0" . 'ESIEA\\PlatformBundle\\Entity\\Advert' . "\0" . 'title', '' . "\0" . 'ESIEA\\PlatformBundle\\Entity\\Advert' . "\0" . 'author', '' . "\0" . 'ESIEA\\PlatformBundle\\Entity\\Advert' . "\0" . 'content', '' . "\0" . 'ESIEA\\PlatformBundle\\Entity\\Advert' . "\0" . 'published', '' . "\0" . 'ESIEA\\PlatformBundle\\Entity\\Advert' . "\0" . 'image'];
        }
