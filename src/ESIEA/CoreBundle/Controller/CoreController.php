...
class CoreController extends Controller
{
  ...
  public function indexAction()
  {
    ...
    return $this->render('ESIEACoreBundle:Core:index.html.twig');
  ...
  public function contactAction(Request $request)
  {
    ...
    return $this->redirectToRoute('esiea_core_home');

    // La méthode longue new RedirectResponse($this->get('router')->generate('esiea_core_home')); est parfaitement valable
  }
}
